"""
MT-007 THERMAL TEST-SET ERROR ANALYSIS
...
PRED_DIR = ROOT / "runs" / "detect" / "results" / "error_analysis" / "MT-007-test-analysis" / "labels"

OUT_DIR = ROOT / "results" / "error_analysis" / "MT-007-test-analysis"
